...
// new CP("10.0.0.153", A, FRONT_LEFT,   13,    0,   CHAIN),
  ...
  new CP("10.0.0.200", B, FRONT,         5,    0,   CHAIN),
  new CP("10.0.0.201", B, FRONT_RIGHT,   5,    0,   CHAIN),
  new CP("10.0.0.202", B, RIGHT,         5,    0,   CHAIN),
  new CP("10.0.0.203", B, REAR_RIGHT,    5,    0,   CHAIN),
  new CP("10.0.0.204", B, REAR,          5,    0,   CHAIN),
  new CP("10.0.0.205", B, REAR_LEFT,     5,    0,   CHAIN),
  new CP("10.0.0.206", B, LEFT,          5,    0,   CHAIN),
  new CP("10.0.0.207", B, FRONT_LEFT,    5,    0,   CHAIN),
  
  new CP("10.0.0.208", B, FRONT,         7,  -20,   CHAIN),
  new CP("10.0.0.209", B, FRONT,         7,   20,   CHAIN),
  new CP("10.0.0.210", B, RIGHT,         7,  -20,   CHAIN),
  new CP("10.0.0.211", B, RIGHT,         7,   20,   CHAIN),
  new CP("10.0.0.212", B, REAR,          7,  -20,   CHAIN),
  new CP("10.0.0.213", B, REAR,          7,   20,   CHAIN),
  new CP("10.0.0.214", B, LEFT,          7,  -20,   CHAIN),
  new CP("10.0.0.215", B, LEFT,          7,   20,   CHAIN),
 
  new CP("10.0.0.216", B, FRONT,         9,  -36,   CHAIN),
  new CP("10.0.0.217", B, FRONT,         9,    0,   CHAIN),
  new CP("10.0.0.218", B, FRONT,         9,   36,   CHAIN),
  new CP("10.0.0.219", B, RIGHT,         9,  -36,   CHAIN),
  new CP("10.0.0.220", B, RIGHT,         9,    0,   CHAIN),
  new CP("10.0.0.221", B, RIGHT,         9,   36,   CHAIN),
  new CP("10.0.0.222", B, REAR,          9,  -36,   CHAIN),
  new CP("10.0.0.223", B, REAR,          9,    0,   CHAIN),
  new CP("10.0.0.224", B, REAR,          9,   36,   CHAIN),
  new CP("10.0.0.225", B, LEFT,          9,  -36,   CHAIN),
  new CP("10.0.0.226", B, LEFT,          9,    0,   CHAIN),
  new CP("10.0.0.227", B, LEFT,          9,   36,   CHAIN),
  
  new CP("10.0.0.228", B, FRONT,        11,  -24,   CHAIN),
  new CP("10.0.0.229", B, FRONT,        11,   24,   CHAIN),
  new CP("10.0.0.230", B, FRONT_RIGHT,  11,    0,   CHAIN),
  new CP("10.0.0.231", B, RIGHT,        11,  -24,   CHAIN),
  new CP("10.0.0.232", B, RIGHT,        11,   24,   CHAIN),
  new CP("10.0.0.233", B, REAR_RIGHT,   11,    0,   CHAIN),
  new CP("10.0.0.234", B, REAR,         11,  -24,   CHAIN),
  new CP("10.0.0.235", B, REAR,         11,   24,   CHAIN),
  new CP("10.0.0.236", B, REAR_LEFT,    11,    0,   CHAIN),
  new CP("10.0.0.237", B, LEFT,         11,  -24,   CHAIN),
  new CP("10.0.0.238", B, LEFT,         11,   24,   CHAIN),
  new CP("10.0.0.239", B, FRONT_LEFT,   11,    0,   CHAIN),
  
  new CP("10.0.0.240", B, FRONT,        13,    0,   CHAIN),
  new CP("10.0.0.241", B, FRONT_RIGHT,  13,    0,   CHAIN),
  new CP("10.0.0.242", B, RIGHT,        13,    0,   CHAIN),
  new CP("10.0.0.243", B, REAR_RIGHT,   13,    0,   CHAIN),
  new CP("10.0.0.244", B, REAR,         13,    0,   CHAIN),
  new CP("10.0.0.245", B, REAR_LEFT,    13,    0,   CHAIN),
  new CP("10.0.0.246", B, LEFT,         13,    0,   CHAIN),
  new CP("10.0.0.247", B, FRONT_LEFT,   13,    0,   CHAIN),
